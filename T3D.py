...
def build_block(_X,block_num,nums_inchannel,keep_prob):
	tp_idx=0
...
def inference_t3d(frames,feature_size,_dropout,block_config=(6, 12, 24, 16)):
	global IS_TRAIN
	IS_TRAIN = True
	...
	with slim.arg_scope([slim.conv3d],
		...
		out=slim.conv3d(frames,START_CHANNEL,[3,7,7],stride=[1,2,2],padding='SAME',biases_initializer=None)
